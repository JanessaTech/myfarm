...
@ApiModel
public class ProviderUpdateVo {
    @ApiModelProperty(value = "供应商ID。符合UUID格式。参考：http://www.uuid.online", required = true, example = "d9a4d5d5-0c9a-4508-952c-091851285a54")
    @NotNull(message = "providerId不能为null")
    @NotBlank(message = "providerId不能为空字符串")
