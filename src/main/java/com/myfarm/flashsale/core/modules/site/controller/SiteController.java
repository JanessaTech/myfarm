...
public class SiteController {
    ...
    public FarmResponse<PageInfo<SiteDto>> getSitesByFilter(@RequestBody(required = true) @Valid SiteFilter siteFilter,
    ...
    public FarmResponse<Object> addSite(@RequestBody(required = true) @Valid SiteDto siteDto) throws SiteParameterException, SiteBusinessException, SiteNotFoundException{
        /**
    ...
    @ApiOperation(value = "修改自提店信息", notes = "【自提店/自提店列表】页面下的 <修改>操作。修改成功后，返回修改后的自提店对象。是否允许修改一个自提店，取决于自提店当前的状态。下面的表格说明不同状态下可以允许的操作：<br>" +
    ...
    public FarmResponse<SiteDto> updateSite(@RequestBody(required = true) @Valid SiteDto siteDto) throws SiteParameterException, SiteBusinessException, SiteNotFoundException{
        /**
